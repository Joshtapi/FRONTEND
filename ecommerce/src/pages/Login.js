...
import { faGoogle, faFacebook, faWindows } from '@fortawesome/free-brands-svg-icons'; // Importar iconos de FontAwesome
import { Link } from 'react-router-dom'; // Importar Link desde React Router
import './LoginScreen.css'; // Asegúrate de importar el archivo de estilos CSS correspondiente
